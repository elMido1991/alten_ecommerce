...
import com.ecommerce.business.db.crudservices.BasketService;
...
public class BasketController {
    ...
    public ResponseEntity<String> addProductToBasket(@RequestBody BasketItem basketItem) {
        try {
            basketService.addProductToBasket(basketItem);
